...
|---|---|---|
| 📊 ZenithRAG | Production RAG on AWS EC2, hybrid FAISS + ChromaDB search | [Live](http://13.60.233.173:8080) |
| 📄 PageWhisper | PDF → voice Q&A via MCP multi-agent orchestration | [Live](https://page-whisper.vercel.app) |
| 🩺 MediQuery AI | RAG-grounded medical Q&A | [Live](https://mediquery-ai.streamlit.app/) |
| 🎯 SkillBridge AI | GenAI career coaching + skill-gap analysis | [Live](https://skill-bridge-ai-orpin.vercel.app) |
| 💰 BitFlow | Real-time WebSocket crypto trading terminal | [Live](https://bit-flow-two.vercel.app) |
| 🍹 Mocktail | GSAP-cinematic mixology showcase | [Live](https://mocktail-seven.vercel.app) |
| 📚 OpenShelf E2E | AI-powered digital library system | [Live](https://openshelf-e2e.streamlit.app/) |
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:6c63ff&height=90&section=footer" width="100%" />
